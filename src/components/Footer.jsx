...
const Footer = () => {
    return ( 
        <footer className="footer grid-cols-3 p-4 bg-black text-gray-300">
...
<div className="grid place-items-center w-full">
  ...
  <div class="w-8 h-8 grid place-items-center mx-2"> <FaInstagram className="text-3xl"/> </div>
        <div class="w-8 h-8 grid place-items-center mx-2"> <FaFacebook className="text-3xl"/> </div>
        <div class="w-8 h-8 grid place-items-center mx-2"> <FaYoutube className="text-3xl"/> </div>
      </nav>
</footer>
     );
}
